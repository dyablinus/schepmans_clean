...
<div class="col-md-8 col-md-offset-2">
    ...
    <table class="table table-striped table-hover">
            ...
            <tr>
                <td><h3 class="text-center"><a href="<?php echo base_url('edit/update/'.$rows->id); ?>"><?php echo $rows->title ?></a></h3></td>
                <td>                            
                ...
                <td class="text-center" scope="row" style="padding-top:2%">
                    ...
                    <a href=" <?php echo base_url('edit/update/'.$rows->id); ?>" class="btn btn-lg btn-success" data-toggle="modal" data-target="#myModal">
                    Modifier
                    </a>
                      <!-- <a href=" <?php echo base_url('edit/update/'.$rows->id); ?>" class="btn btn-lg btn-success">Modifier</a>   -->
