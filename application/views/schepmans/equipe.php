...
<div class="row row_equipe text-center">
    ...
    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
        ...
        <div class="col-xs-6 col-sm-6 col-md-8 col-lg-8 block_equipe">
            ...
            <div class="elue_equipe"> (CDH - CD&V)</div>
            <div class="role_equipe">1er Echevin</div>
            <div class="email_equipe"><i class="fa fa-mobile plane_equipe" aria-hidden="true"></i>02 / 412 37 30</div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 last_team_people">
        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 block_equipe ">
            <div class="elue_equipe">Sarah TURINE</div>
            <div class="elue_equipe"> (ECOLO - GROEN)</div>
            <div class="role_equipe">2ème Echevine</div>
            <div class="email_equipe"><i class="fa fa-mobile plane_equipe" aria-hidden="true"></i>02 / 600 49 47</div>
    ...
    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
        ...
        <div class="col-xs-6 col-sm-6 col-md-8 col-lg-8 block_equipe block_equipe_last">
            <div class="elue_equipe">Patricia Vande Maele</div>
            <div class="elue_equipe"> (MR - OPEN VLD)</div>
            <div class="role_equipe">3ème Echevine</div>
            <div class="email_equipe"><i class="fa fa-mobile plane_equipe" aria-hidden="true"></i>02 / 412 36 40</div>
...
<div class="row row_equipe text-center">
    ...
    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
        ...
        <div class="col-xs-6 col-sm-6 col-md-8 col-lg-8 block_equipe">
            ...
            <div class="email_equipe"><i class="fa fa-mobile plane_equipe" aria-hidden="true"></i>02 / 600 49 53</div>
    ...
    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
        ...
        <div class="col-xs-6 col-sm-6 col-md-8 col-lg-8 block_equipe">
            ...
            <div class="email_equipe"><i class="fa fa-mobile plane_equipe" aria-hidden="true"></i>02 / 412 37 20</div>
    ...
    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
        ...
        <div class="col-xs-6 col-sm-6 col-md-8 col-lg-8 block_equipe block_equipe_last">
            ...
            <div class="email_equipe"><i class="fa fa-mobile plane_equipe" aria-hidden="true"></i>02 / 412 37 50</div>
...
<div class="row row_equipe text-center">
    ...
    <div class="col-xs-6 col-sm-6 col-md-4 col-lg-4">
        ...
        <div class="col-xs-6 col-sm-6 col-md-8 col-lg-8 block_equipe">
            ...
            <div class="email_equipe"><i class="fa fa-mobile plane_equipe" aria-hidden="true"></i>02 / 412 36 80</div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 last_team_people">
        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 block_equipe">
            ...
            <div class="email_equipe"><i class="fa fa-mobile plane_equipe" aria-hidden="true"></i>02 / 412 37 60</div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4 last_team_people">
        ...
        <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 block_equipe block_equipe_last">
            ...
            <div class="email_equipe"><i class="fa fa-mobile plane_equipe" aria-hidden="true"></i>02 / 600 49 47 - 02 / 412 37 81</div>
